...
const Enrutador = {
    ...
    MAPA_RUTAS: {
        ...
        "Perfil de la Escuela": { url: "vistas/escuela/perfil.html" } // NUEVA RUTA
    },
    ...
    cargarVista: async function(nombreVista, guardarHistorial = true) {
        ...
        Aplicacion.marcarMenuActivo(nombreVista);
        ...
        try {
            if (Aplicacion.ModulosSistema[nombreVista]) {
    ...
    mostrarMockup: function(nombre, contenedor) {
        ...
        <div class="vista-entrar h-100 d-flex flex-column align-items-center justify-content-center text-center py-5" style="min-height: 60vh;">
            ...
            <button class="btn-moderno btn-primario mt-4 shadow" onclick="window.history.back()"><i class="bi bi-arrow-left me-2"></i> Volver atrás</button>
        </div>`;
    }
};