...
const Enrutador = {
    ...
    MAPA_RUTAS: {
        ...
        // ✨ NUEVA RUTA PARA TRANSPORTE ESCOLAR ✨
    ...
    cargarVista: async function(nombreVista, guardarHistorial = true) {
        ...
        try {
            // Si es una Categoría Principal (Dashboard de tarjetas)
            ...
            // Si es una vista HTML específica del mapa de rutas
                ...
                if (response.ok) { 
                    ...
                    // Ejecuta la función de inicio del módulo si existe
