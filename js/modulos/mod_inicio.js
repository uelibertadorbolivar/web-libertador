    ...
    cargarPerfilEscuela: function() {
        window.Aplicacion.peticion({ action: "get_school_profile" }, (res) => {
            if (res && res.status === "success" && res.perfil) {
                ...
                // ✨ CORRECCIÓN: Ahora lee "p.objetivo" tal como lo manda el Code.gs ✨
