...
window.ModSolicitud = {
    ...
    cargarDiccionarios: function() {
        ...
        window.Aplicacion.peticion({ action: "get_diccionarios_solicitud" }, (res) => {
            ...
            if(res && res.status === "success") {
                ...
                Swal.fire('Error de Conexión', 'Hubo un problema al cargar los diccionarios.', 'error');
            }
        });
    },
    ...
    generarPDFResumen: async function(datosPDF) {
        ...
        setTimeout(() => {
            ...
            if (datosPDF.reconocido_por === "Ambos Padres" || datosPDF.reconocido_por === "Solo la Madre") {
                ...
                rowFull("Dirección", datosPDF.madre_direccion); // ✨ CORRECCIÓN
                y += 2;
            }
            if (datosPDF.reconocido_por === "Ambos Padres" || datosPDF.reconocido_por === "Solo el Padre") {
                ...
                rowFull("Dirección", datosPDF.padre_direccion); // ✨ CORRECCIÓN
            }
    ...
    guardarSolicitud: function() {
        ...
        // ✨ CORRECCIÓN: Capturamos las nuevas direcciones
        let payloadParaPDF = {
        ...
        let payloadBD = Object.assign({}, payloadParaPDF, { 
            ...
            rep_telefono: rep_tel_BD, madre_telefono: madre_tel_BD, padre_telefono: padre_tel_BD
        });
        ...
        if (reqMadre) {
            ...
            if(!payloadBD.madre_direccion) camposFaltantes.push("Paso 5 (Madre): Dirección de Habitación"); // ✨ CORRECCIÓN
        }
        ...
        if (reqPadre) {
            ...
            if(!payloadBD.padre_direccion) camposFaltantes.push("Paso 5 (Padre): Dirección de Habitación"); // ✨ CORRECCIÓN
        }
        ...
        window.Aplicacion.peticion(payloadBD, (res) => {
            ...
            if (res && res.status === "success") {
                Swal.fire({
                    ...
                    if (result.isConfirmed) { window.ModSolicitud.generarPDFResumen(payloadParaPDF); } 
